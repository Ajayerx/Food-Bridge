  ...
  <TouchableOpacity
    ...
    <View style={styles.content}>
      <View style={styles.topRow}>
        ...
        {/* ✅ FIXED: backend returns `average_rating`, not `rating` */}
...
const styles = StyleSheet.create({
  ...
  promotedText: { color: Colors.white, fontSize: 10, fontWeight: '700', letterSpacing: 1 },
  closedOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'rgba(0,0,0,0.45)',
    justifyContent: 'center', alignItems: 'center',
  },
  closedText: { color: Colors.white, fontSize: 18, fontWeight: '700', letterSpacing: 2 },
  content: { padding: 14 },
  topRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  name: { fontSize: 16, fontWeight: '700', color: Colors.textPrimary, flex: 1, marginRight: 8 },
  cuisines: { fontSize: 13, color: Colors.textSecondary, marginBottom: 6 },
