      ...
      Geolocation.getCurrentPosition(
        ...
        (error) => {
          if (error.code === 1) {
            ...
            setGpsError(LOCATION_ERRORS.POSITION_UNAVAILABLE);
          } else if (error.code === 3) {
            setGpsError(LOCATION_ERRORS.TIMEOUT);
          } else {
            setGpsError(LOCATION_ERRORS.TIMEOUT);
          }
          setGpsLoading(false);
      ...
      Geolocation.requestAuthorization(
        ...
        (status) => {
          if (status === "granted") {
            ...
            Alert.alert(
              "Location Access",
              LOCATION_ERRORS.PERMANENT_DENIED,
              [
  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        <TextInput
          ref={ref => { fieldRefs.current.addressLine1 = ref; }}
          style={[
            styles.input,
        ...
        <TextInput
          style={[
            styles.input,
            highlightedFields.addressLine2 ? styles.highlighted : null,
          ]}
          value={addressLine2}
