...
export const OrdersScreen = ({ navigation }) => {
  ...
  const iosPickerStyles = useMemo(() => createIosPickerStyles(Colors), [Colors]);
  const chipStyles = useMemo(() => createChipStyles(Colors), [Colors]);
  const STATUS_STYLE = {
    Placed: { color: Colors.info, bg: '#EBF5FB', icon: 'receipt-long' },
    Confirmed: { color: '#9B59B6', bg: '#F5EEF8', icon: 'check-circle' },
    Preparing: { color: '#E67E22', bg: '#FEF9E7', icon: 'restaurant' },
    'Ready for Pickup': { color: Colors.warning, bg: '#FEF9E7', icon: 'hourglass-empty' },
...
const createCalStyles = (C) => StyleSheet.create({
  overlay: {
    flex: 1,
...
const createIosPickerStyles = (C) => StyleSheet.create({
  overlay: {
    flex: 1,
  ...
  cancelBtn: { fontSize: 16, fontWeight: '600', color: C.textSecondary },
  headerTitle: { fontSize: 16, fontWeight: '700', color: C.textPrimary },
  doneBtn: { fontSize: 16, fontWeight: '700', color: C.primary },
  picker: { height: 200, width: '100%' },
});

// ─── Chip styles ──────────────────────────────────────────
const createChipStyles = (C) => StyleSheet.create({
  wrapper: {
    backgroundColor: C.surface,
    borderBottomWidth: 1,
    borderBottomColor: C.border,
  ...
  divider: { width: 1, height: 20, backgroundColor: C.border, marginHorizontal: 2 },
  clearChip: {
  ...
  clearText: { fontSize: 12, fontWeight: '700', color: C.error },
  summaryRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
...
const createStyles = (C) => StyleSheet.create({
  ...
  header: {
    ...
    elevation: 2, shadowColor: C.black, shadowOffset: { width: 0, height: 1 },
  ...
  tabIndicator: {
    position: 'absolute', top: 4, bottom: 4, backgroundColor: C.surface,
    borderRadius: 9, elevation: 2, shadowColor: C.black,
  ...
  listLabel: { fontSize: 13, fontWeight: '600', color: C.textSecondary },
  filterActivePill: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    backgroundColor: C.primaryLight, paddingHorizontal: 10,
    paddingVertical: 3, borderRadius: 20,
  },
  filterActivePillText: { fontSize: 11, fontWeight: '700', color: C.primary },
  ...
  activeBannerTitle: { fontSize: 13, color: C.textSecondary, fontWeight: '500' },
  activeBannerRest: { fontSize: 15, fontWeight: '700', color: C.textPrimary },
  ...
  orderCard: {
    ...
    padding: 16, elevation: 2, shadowColor: C.black,
  ...
  restThumb: { width: 48, height: 48, borderRadius: 12, backgroundColor: C.background },
  restThumbFallback: { justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: C.border },
  orderCardHeaderInfo: { flex: 1 },
  orderRestName: { fontSize: 15, fontWeight: '700', color: C.textPrimary, marginBottom: 2 },
  orderDate: { fontSize: 11, color: C.textLight },
  orderItems: {
    flexDirection: 'row', alignItems: 'flex-start', gap: 6, marginBottom: 12,
    paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: C.divider,
  },
  orderItemsText: { flex: 1, fontSize: 13, color: C.textSecondary, lineHeight: 18 },
  ...
  orderTotal: { fontSize: 15, fontWeight: '800', color: C.textPrimary },
  orderDot: { width: 4, height: 4, borderRadius: 2, backgroundColor: C.border },
  orderCount: { fontSize: 12, color: C.textSecondary },
  ...
  reorderBtn: {
    ...
    backgroundColor: C.primaryLight, borderWidth: 1,
    borderColor: C.primary + '33', minWidth: 80, justifyContent: 'center',
  },
  reorderText: { fontSize: 12, fontWeight: '700', color: C.primary },
  detailBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 3,
    paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: C.background,
  },
  detailBtnText: { fontSize: 12, color: C.textSecondary, fontWeight: '500' },

  filterEmpty: { alignItems: 'center', paddingTop: 60, paddingHorizontal: 32, gap: 10 },
  filterEmptyEmoji: { fontSize: 48 },
  filterEmptyTitle: { fontSize: 17, fontWeight: '800', color: C.textPrimary },
  filterEmptySub: { fontSize: 13, color: C.textSecondary, textAlign: 'center' },
  filterEmptyBtn: {
  ...
  filterEmptyBtnText: { fontSize: 13, fontWeight: '700', color: C.primary },
});