        ...
        <div className="container">
          ...
          <div id="prev-mobile" className="preview-panel">
            ...
            <div style={{display: 'flex', justifyContent: 'center', gap: '32px', alignItems: 'flex-start', padding: '20px 0'}} className="reveal">
              ...
              {/* Download */}
              <div style={{textAlign: 'center', paddingBottom: '20px'}} className="reveal delay-1">
                <div className="btn-orbit-wrap">
                  <div className="orbit-ring"></div>
                   <a href="https://softgowaytechnologies-my.sharepoint.com/:u:/g/personal/ajays_softgoway_com/IQDx-_DwdovrR732aJLWSJ8jASTCzY7S15_GSPm50igsN2c" target="_blank" rel="noopener noreferrer" className="btn-orbit">
                    <i className="ti ti-device-mobile-down" aria-hidden="true"></i>
                    Download Demo App
                  </a>
                  <span className="orbit-badge">New · v1.0</span>
                </div>
              </div>
            </div>
          </div>
