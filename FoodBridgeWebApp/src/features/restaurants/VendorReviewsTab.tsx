...
export const VendorNotificationBell: React.FC = () => {
  ...
  // Real-time: listen for new notifications via SignalR
  React.useEffect(() => {
    ...
    notificationHub.on("receivenotification", handleNotif);
    return () => notificationHub.off("receivenotification", handleNotif);
  }, [qc]);
...
export const VendorReviewsTab: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    notificationHub.on("receivenotification", handle);
    return () => notificationHub.off("receivenotification", handle);
  }, [qc]);
